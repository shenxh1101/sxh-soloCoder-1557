...
export default function Dashboard() {
  ...
  const todaySale = getSaleByDate(today);
    ...
    <div className="space-y-6 p-8">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                {lowStockMaterials.map(material => (
                  <div
                    key={material.id}
                    className="bg-white px-4 py-2 rounded-xl shadow-sm border border-red-200 flex items-center gap-2 animate-pulse-slow"
                  >
                    ...
                    <span className="text-sm text-red-500">
                      (剩余 {material.stock}{material.unit}，安全库存 {material.safeStock}{material.unit})
                    </span>
                  </div>
                ))}
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="stat-card animate-fadeInUp">
          ...
          <p className="text-3xl font-bold text-brown-500">
            ¥{todayPurchaseAmount.toFixed(2)}
          </p>
          <p className="text-sm text-brown-400 mt-1">
            {todayPurchases.length} 笔采购记录
          </p>
        </div>

        <div className="stat-card animate-fadeInUp delay-100" style={{ animationDelay: '0.1s' }}>
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-3xl font-bold text-green-600">
            ¥{todaySale ? todaySale.totalRevenue.toFixed(2) : '0.00'}
          </p>
          <p className="text-sm text-brown-400 mt-1">
            {todaySale ? '已录入销售' : '还未录入销售'}
          </p>
        </div>

        <div className="stat-card animate-fadeInUp delay-200" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center justify-between mb-4">
        ...
        <div className="stat-card animate-fadeInUp delay-300" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center justify-between mb-4">
        ...
        <div className="card animate-fadeInUp delay-100" style={{ animationDelay: '0.1s' }}>
          ...
          {topProduct && (
            <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-primary-50 to-orange-50 rounded-2xl border border-primary-200">
              ...
              <div className="bg-primary-500 text-white px-4 py-2 rounded-xl font-bold">
                🏆 冠军
              </div>
            </div>
          )}
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-brown-400 mt-1">
                  安全库存: {material.safeStock}{material.unit}
                </p>
              </div>
            );
          })}
